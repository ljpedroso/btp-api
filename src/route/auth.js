...
module.exports = function (router) {
  ...
  router.post('/sign-up', middleware.isAuth, validator.signUp, auth.signUp)
  ...
  router.post('/reset-password', middleware.isAuth, validator.resetPassword, auth.resetPassword)
  router.post('/new-password', middleware.isAuth, validator.newPassword, auth.newPassword)
